...
def enq_scatter_plot(tmp_path : str, chart_obj : Chart) -> None: #TODO add try/catch

    '''
    
        Enqueues a validated data file for a scatter plot chart 
    ...
    channel.queue_bind(queue="scatter_plot_q", exchange="scatter_plot_charts")
    ...
    with open(tmp_path, "rb") as data_file:
        ...
        channel.basic_publish(exchange="scatter_plot_charts", 
                              routing_key="", 
                              body=msg, 
                              properties=props)
