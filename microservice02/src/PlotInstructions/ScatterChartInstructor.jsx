...
function ScatterChartInstructor({hideChart, title}) {

    return (
        <div className={"mb-4 row-start-2 col-start-1 box-border border-l-neutral-950 border-r-transparent border-b-transparent border-t-transparent h-12- w-9/12 p-4 border-2"}>
            <h2
...
export default ScatterChartInstructor;